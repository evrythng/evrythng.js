  ...
  static resourceFactory() {
    return {
      location() {
        ...
        // See `updateLocation()`.
        return Object.assign(Resource.factoryFor(Location, thngPath + path$4).call(this), {
          update(...args) {
...
function updateLocation(...args) {
  let [data, ...rest] = normalizeArguments$2(...args);
...
const path$3 = '/thngs';
const ThngResources = mixinResources([Property, Action, Location]);
  ...
  static resourceFactory() {
    return {
      collection(id) {
        ...
        return Object.assign(Resource.factoryFor(Collection, path$5, CollectionResources).call(this, id), Collection.resourceFactory());
      }
    };
  }
}
...
class ActionType extends Entity {
  ...
  static resourceFactory() {
    return {
      actionType(id) {
        return Object.assign(Resource.factoryFor(ActionType, path$6).call(this, id), {
          read(...args) {
...
function readActionType(id, ...args) {
  if (!id) {
    ...
    const normalizedArgs = normalizeArguments$3(id)(...args);
    return new Promise((resolve, reject) => {
 ...
 */
function normalizeArguments$3(id) {
  return (...args) => {
    let options;
    let firstArg = args[0];
  ...
  static resourceFactory() {
    return {
      status() {
        ...
        return Resource.factoryFor(Status, path$10).call(this);
      }
    };
  }
}

const path$9 = '/reactor/script';
  ...
  static resourceFactory() {
    return {
      reactorScript() {
        ...
        return Resource.factoryFor(ReactorScript, path$9, ReactorScriptResources).call(this);
      }
    };
  }
}

const path$11 = '/reactor/schedules';
  ...
  static resourceFactory() {
    return {
      reactorSchedule(id) {
        ...
        return Resource.factoryFor(ReactorSchedule, appPath + path$11).call(this, id);
      }
    };
  }
}

const path$12 = '/reactor/logs';
  ...
  static resourceFactory() {
    return {
      reactorLog(id) {
        ...
        return Object.assign(Resource.factoryFor(ReactorLog, appPath + path$12).call(this, id), {
          create(...args) {
  ...
  static resourceFactory() {
    return {
      application(id) {
        ...
        return Resource.factoryFor(Application, path$8, ApplicationResources).call(this, id);
      }
    };
  }
}

const path$7 = '/projects';
...
class Project extends ProjectResources(Entity) {
  ...
  static resourceFactory() {
    return {
      project: Resource.factoryFor(Project, path$7, ProjectResources)
    };
  }
}

const path$14 = '/permissions';
  ...
  static resourceFactory() {
    return {
      permission() {
        ...
        return Resource.factoryFor(Permission, path$14).call(this);
      }
    };
  }
}
...
class Role extends RoleResources(Entity) {
  ...
  static resourceFactory() {
    return {
      role: Resource.factoryFor(Role, path$13, RoleResources)
    };
  }
}
...
class User extends Entity {
  ...
  static resourceFactory() {
    return {
      user: Resource.factoryFor(User, path$15)
    };
  }
}
  ...
  static resourceFactory() {
    return {
      task(id) {
        ...
        return Resource.factoryFor(Task, path$17).call(this, id);
      }
    };
  }
}

const path$16 = '/batches';
...
class Batch extends BatchResources(Entity) {
  ...
  static resourceFactory() {
    return {
      batch: Resource.factoryFor(Batch, path$16, BatchResources)
    };
  }
}

const path$18 = '/places';
...
class Place extends Entity {
  ...
  static resourceFactory() {
    return {
      place: Resource.factoryFor(Place, path$18)
    };
  }
}
...
class File extends Entity {
  ...
  static resourceFactory() {
    ...
    return {
      file: Resource.factoryFor(File, path$19)
    };
  }
}
...
const path$20 = '/auth/evrythng/users';
...
class UserAccess$1 extends Entity {
  ...
  static resourceFactory() {
    return {
      userAccess(id) {
        return Object.assign(Resource.factoryFor(UserAccess$1, path$20).call(this, id), {
          create(...args) {
...
export { version, settings, setup, api, Operator, Application$1 as Application, TrustedApplication, User$1 as User, Device, entities as Entity, symbols as Symbol, Resource as _Resource, Entity as _Entity, Scope as _Scope };
//# sourceMappingURL=evrythng.es.polyfill.js.map
