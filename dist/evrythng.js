...
function updateLocation() {
  var _normalizeArguments = normalizeArguments$2.apply(undefined, arguments),
      _normalizeArguments2 = toArray(_normalizeArguments),
      data = _normalizeArguments2[0],
      rest = _normalizeArguments2.slice(1);
...
var path$3 = '/thngs';
var ThngResources = mixinResources([Property, Action, Location]);
...
function readActionType(id) {
  ...
  if (!id) {
    ...
    var normalizedArgs = normalizeArguments$3(id).apply(undefined, args);
    return new Promise(function (resolve, reject) {
...
var path$20 = '/auth/evrythng/users';
    ...
    value: function resourceFactory() {
      return {
        userAccess: function userAccess(id) {
          return Object.assign(Resource.factoryFor(UserAccess, path$20).call(this, id), {
            create: function create() {
              for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                args[_key] = arguments[_key];
              }
...
//# sourceMappingURL=evrythng.js.map
