...
module.exports = (scopeType, url) => {
  describe('Accesses', () => {
    ...
    it('should read all account accesses', async () => {
      api.get('/accounts/accountId/accesses').reply(200, [{ id: 'accessId' }])
    ...
    it('should read a single account access', async () => {
      api.get('/accounts/accountId/accesses/accessId').reply(200, { id: 'accessId' })
    ...
    it('should update a single account access', async () => {
      ...
      api.put('/accounts/accountId/accesses/accessId', payload).reply(200, { id: 'accessId' })
