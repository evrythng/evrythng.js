  ...
  describe('OperatorAccesses', () => {
    ...
    if (settings.apiVersion == 2) {
      it('should create operator access', async () => {
        api
          .post('/accounts/accountId/operatorAccess', payload)
      ...
      it('should read operator access by id', async () => {
        ...
        const res = await scope
          ...
          .operatorAccess('operatorAccessId')
          .read()
      ...
      it('should read all operator accesses', async () => {
        api.get('/accounts/accountId/operatorAccess').reply(200, [payload])
      ...
      it('should update operator access', async () => {
        api.put('/accounts/accountId/operatorAccess/operatorAccessId', payload).reply(200, payload)
      ...
      it('should delete operator access', async () => {
        api.delete('/accounts/accountId/operatorAccess/operatorAccessId').reply(204)
        const res = await scope
          .sharedAccount('accountId')
          .operatorAccess('operatorAccessId')
          .delete()
