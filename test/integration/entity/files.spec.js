...
module.exports = (scopeType, apiUrl) => {
  describe('Files', () => {
    let scope, api
    ...
    it('should create a file', async () => {
      ...
      api.post('/files', payload).reply(201, payload)
    ...
    it('should read all files', async () => {
      api.get('/files').reply(200, [{ id: 'fileId' }])
    ...
    it('should read a file', async () => {
      api.get('/files/fileId').reply(200, { id: 'fileId' })
    ...
    it.skip('should upload file content - text', async () => {
      const fileData = 'This is example text file content'

      api.get('/files/fileId').reply(200, { id: 'fileId', uploadUrl: 'https://s3.amazonaws.com' })
      await scope.file('fileId').upload(fileData)

      api.get('/files/fileId').reply(200, { contentUrl: 'https://s3.amazonaws.com/upload' })
    ...
    it('should delete a file', async () => {
      api.delete('/files/fileId').reply(200)
