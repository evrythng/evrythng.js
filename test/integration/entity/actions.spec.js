...
module.exports = (scopeType, url) => {
  ...
  describe('Actions', () => {
    ...
    it('should create an action', async () => {
      ...
      api.post('/actions/scans', payload).reply(201, { id: 'actionId' })
    ...
    it('should read all actions of a type', async () => {
      api.get('/actions/scans').reply(200, [{ id: 'actionId' }])
    ...
    it('should create an aliased action', async () => {
      ...
      api.post('/thngs/thngId/actions/scans', payload).reply(201, { id: 'actionId' })
    ...
    it('should read all aliased actions', async () => {
      api.get('/thngs/thngId/actions/scans').reply(200, [{ id: 'actionId' }])
    ...
    if (scopeType === 'operator') {
      it('should read a single action', async () => {
        api.get('/actions/scans/actionId').reply(200, { id: 'actionId' })
      ...
      it('should delete an action', async () => {
        api.delete('/actions/scans/actionId').reply(200)
