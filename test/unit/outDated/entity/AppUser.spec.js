...
import { apiKey, optionsTemplate, userTemplate, userAccessTemplate } from '../../helpers/data'
  ...
  describe('resourceFactory', () => {
    ...
    describe('create', () => {
      ...
      it('should support callback in third param', (done) => {
        userAccessResource
          .create(userTemplate, optionsTemplate, cb)
          .then(() => {
      ...
      it('should create anonymous user', (done) => {
        const anonymousUserTemplate = Object.assign({ anonymous: true }, userTemplate)
        userAccessResource
          .create(anonymousUserTemplate)
          .then(() => {
            expect(fetchMock.lastOptions()).toEqual(
              jasmine.objectContaining({
                apiKey,
